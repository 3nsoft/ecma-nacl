...
function makeEncryptor(pk, sk, nextNonce, delta, arrFactory) {
    ...
    var k = calc_dhshared_key(pk, sk), enc = sbox.formatWN.makeEncryptor(k, nextNonce, delta, arrFactory);
    arrFactory.wipe(k);
    return enc;
}
/**
...
function makeDecryptor(pk, sk, arrFactory) {
    ...
    var k = calc_dhshared_key(pk, sk), enc = sbox.formatWN.makeDecryptor(k, arrFactory);
    arrFactory.wipe(k);
    return enc;
}
exports.formatWN = {
