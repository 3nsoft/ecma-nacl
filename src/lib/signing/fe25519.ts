...
export function make_fe25519(arrFactory: Factory): fe25519 {
	return <fe25519> arrFactory.getUint32Array(32);
}

function make_copy_fe25519(x: fe25519, arrFactory: Factory): fe25519 {
	const c = arrFactory.getUint32Array(32);
	c.set(x);
	return <fe25519> c;
}
...
export function pack(
	r: Uint8Array, x: fe25519, arrFactory: Factory
): void {
	const y = make_copy_fe25519(x, arrFactory);
	fe25519_freeze(y);
	for(let i=0; i<32; i+=1) { 
		r[i] = y[i];
	}
 ...
 */
export function iseq_vartime(
	x: fe25519, y: fe25519, arrFactory: Factory
): boolean {
	const t1 = make_copy_fe25519(x, arrFactory);
	const t2 = make_copy_fe25519(y, arrFactory);
	fe25519_freeze(t1);
	fe25519_freeze(t2);
	for(let i=0; i<32; i+=1) {
 ...
 */
export function getparity(x: fe25519, arrFactory: Factory): number {
	const t = make_copy_fe25519(x, arrFactory);
	fe25519_freeze(t);
	const res = t[0] & 1;
 ...
 */
export function neg(r: fe25519, x: fe25519, arrFactory: Factory): void {
	const t = make_copy_fe25519(x, arrFactory);
	setzero(r);
...
export function sub(
	...
	const t = make_fe25519(arrFactory);
	t[0] = x[0] + 0x1da;
...
export function mul(
	...
	const t = arrFactory.getUint32Array(63);
 ...
 */
export function square(r: fe25519, x: fe25519, arrFactory: Factory): void {
 ...
 */
export function invert(r: fe25519, x: fe25519, arrFactory: Factory): void {
	const z2 = make_fe25519(arrFactory);
	const z9 = make_fe25519(arrFactory);
	const z11 = make_fe25519(arrFactory);
	const z2_5_0 = make_fe25519(arrFactory);
	const z2_10_0 = make_fe25519(arrFactory);
	const z2_20_0 = make_fe25519(arrFactory);
	const z2_50_0 = make_fe25519(arrFactory);
	const z2_100_0 = make_fe25519(arrFactory);
	const t0 = make_fe25519(arrFactory);
	const t1 = make_fe25519(arrFactory);
	...
	/* 2^20 - 2^10 */ for (let i = 2;i < 10;i += 2) {
	...
	/* 2^40 - 2^20 */ for (let i = 2; i < 20; i += 2) {
							square(t0,t1,arrFactory);
							square(t1,t0,arrFactory);
						}
	...
	/* 2^50 - 2^10 */ for (let i = 2; i < 10; i += 2) {
							square(t1,t0,arrFactory);
							square(t0,t1,arrFactory);
						}
	...
	/* 2^100 - 2^50 */ for (let i = 2; i < 50; i += 2) {
							square(t0,t1,arrFactory);
							square(t1,t0,arrFactory);
						}
	...
	/* 2^200 - 2^100 */ for (let i = 2;i < 100;i += 2) {
							square(t1,t0,arrFactory);
							square(t0,t1,arrFactory);
						}
	...
	/* 2^250 - 2^50 */ for (let i = 2; i < 50; i += 2) {
							square(t0,t1,arrFactory);
							square(t1,t0,arrFactory);
						}
 ...
 */
export function pow2523(r: fe25519, x: fe25519, arrFactory: Factory): void {
	const z2 = make_fe25519(arrFactory);
	const z9 = make_fe25519(arrFactory);
	const z11 = make_fe25519(arrFactory);
	const z2_5_0 = make_fe25519(arrFactory);
