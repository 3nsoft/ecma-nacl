 ...
 */
function packWithNonce(m: Uint8Array, n: Uint8Array, k: Uint8Array,
		arrFactory?: arrays.Factory): Uint8Array {
	if (!arrFactory) { arrFactory = new arrays.Factory(); }
 ...
 * Array is a view of buffer, which has 32 zeros preceding message bytes.
 */
function openArrWithNonce(c: Uint8Array, k: Uint8Array,
		arrFactory?: arrays.Factory): Uint8Array {
 ...
 */
function makeEncryptor(key: Uint8Array, nextNonce: Uint8Array,
 ...
 */
function makeDecryptor(key: Uint8Array,
