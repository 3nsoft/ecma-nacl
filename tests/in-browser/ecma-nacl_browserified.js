 ...
 */
function makeEncryptor(pk, sk, nextNonce, arrFactory) {
    if (!arrFactory) {
        arrFactory = new arrays.Factory();
    }
    var k = calc_dhshared_key(pk, sk), enc = sbox.formatWN.makeEncryptor(k, nextNonce, 2, arrFactory);
    arrFactory.wipe(k);
    return enc;
}
/**
...
},{"../util/arrays":19,"./core":2,"./scalarmult":4,"./secret_box":5,"./stream":6}],2:[function(require,module,exports){
/* Copyright(c) 2013-2015 3NSoft Inc.
 * This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, you can obtain one at http://mozilla.org/MPL/2.0/. */
...
},{"../util/verify":21}],4:[function(require,module,exports){
/* Copyright(c) 2013-2015 3NSoft Inc.
 * This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, you can obtain one at http://mozilla.org/MPL/2.0/. */
...
},{"../util/arrays":19,"../util/nonce":20,"./onetimeauth":3,"./stream":6}],6:[function(require,module,exports){
/* Copyright(c) 2013 - 2015 3NSoft Inc.
 * This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, you can obtain one at http://mozilla.org/MPL/2.0/. */
...
},{"../util/arrays":19,"./core":2}],"4jzRDE":[function(require,module,exports){
/* Copyright(c) 2013 - 2015 3NSoft Inc.
 * This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, you can obtain one at http://mozilla.org/MPL/2.0/. */
...
},{"./boxes/box":1,"./boxes/secret_box":5,"./file/xsp":10,"./hash/sha512":11,"./scrypt/scrypt":12,"./signing/sign":18,"./util/arrays":19,"./util/nonce":20,"./util/verify":21}],"ecma-nacl":[function(require,module,exports){
module.exports=require('4jzRDE');
 ...
 * header's bytes. Arrays's length is used to decide on how to process it.
 * @param masterKey
 * @param segSizein256bs defines a size of a regular segment in chunks of 256.
 * @param randomBytes is a function that produces cryptographically strong
 * random numbers (bytes).
 * @param arrFactory (optional)
 */
function makeWriter(header, masterKey, segSizein256bs, randomBytes, arrFactory) {
    if (!arrFactory) {
        arrFactory = new arrays.Factory();
    }
    var writer = new SegWriter(header, masterKey, segSizein256bs, randomBytes, arrFactory);
    return makeWriterWrap(writer);
}
...
},{"../boxes/secret_box":5,"../util/arrays":19,"../util/nonce":20}],10:[function(require,module,exports){
/* Copyright(c) 2015 3NSoft Inc.
 * This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, you can obtain one at http://mozilla.org/MPL/2.0/. */
...
},{"./xsp-segments":9}],11:[function(require,module,exports){
/* Copyright(c) 2015 3NSoft Inc.
 * This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, you can obtain one at http://mozilla.org/MPL/2.0/. */
...
},{"../util/arrays":19}],12:[function(require,module,exports){
/* Copyright(c) 2015 3NSoft Inc.
 * This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, you can obtain one at http://mozilla.org/MPL/2.0/. */
...
},{"../util/arrays":19,"./sha256":13}],13:[function(require,module,exports){
/* Copyright(c) 2015 3NSoft Inc.
 * This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, you can obtain one at http://mozilla.org/MPL/2.0/. */
...
},{"../util/arrays":19,"./fe25519":14,"./ge25519_base.data":16,"./sc25519":17}],16:[function(require,module,exports){
/* Copyright(c) 2015 3NSoft Inc.
 * This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, you can obtain one at http://mozilla.org/MPL/2.0/. */
...
(function () {
    ...
    var arrFact = new arrays.Factory();
...
},{"../util/arrays":19,"./fe25519":14}],17:[function(require,module,exports){
/* Copyright(c) 2015 3NSoft Inc.
 * This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, you can obtain one at http://mozilla.org/MPL/2.0/. */
...
},{"../hash/sha512":11,"../util/arrays":19,"../util/verify":21,"./ge25519":15,"./sc25519":17}],19:[function(require,module,exports){
/* Copyright(c) 2013-2015 3NSoft Inc.
 * This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, you can obtain one at http://mozilla.org/MPL/2.0/. */
