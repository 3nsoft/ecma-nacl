...
import { fe25519, make_fe25519 } from './fe25519';
...
export function make_ge25519_aff(arrFactory: Factory): ge25519_aff {
	return <ge25519_aff> {
		x: make_fe25519(arrFactory),
		y: make_fe25519(arrFactory)
	};
}

export const base_multiples_affine = new Array<ge25519_aff>(425);
