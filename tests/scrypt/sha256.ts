...
console.log("Testing of SHA256 for use in scrypt.");
...
compare(result, expected, "Hashes are different");
arrFactory.wipe(result);
console.log("PASS.");
console.log();

/**
 * Test PBKDF2 with HMAC-SHA-256
 */

console.log("Testing PBKDF2 with HMAC-SHA-256");
...
expectation.set([ 0x55, 0xac, 0x04, 0x6e, 0x56, 0xe3, 0x08, 0x9f, 0xec, 0x16,
...
c = 80000;
dkLen = 64;
expectation.set([ 0x4d, 0xdc, 0xd8, 0xf6, 0x0b, 0x98, 0xbe, 0x21, 0x83, 0x0c,
